 ...
 * @author mkino
 */
public class BACStudents extends UniversityStudent {
     ...
     private String courseIntake;
        ...
        public BACStudents(String name, int age,int registrationNumber,String faculty,String course,String courseType,String courseDuration,String courseIntake)
        {
